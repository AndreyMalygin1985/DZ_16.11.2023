...
int main()
{
	...
	Worker slaves[7]
	{
		Worker("Карпова Милана Романовна", "Менеджер", 2000, 55000),
		Worker("Сафонова София Тимофеевна", "Менеджер", 2000, 60000),
		Worker("Верещагина Александра Дамировна", "ИТ", 2001, 77000),
		Worker("Ковалев Богдан Михайлович", "ИТ", 2002, 80000),
		Worker("Жуков Тимур Юрьевич", "Рабочий", 2018, 50000),
		Worker("Смирнов Дмитрий Александрович", "Рабочий", 2004, 45000),
	...
	do
	{
		...
		case 1:
			...
			break;
		case 2:	{
			cout << "Введите стаж работы от 0 до 24 лет:  ";
			int experience;
			cin >> experience;
			Worker temp[7];
			int count{ 0 };
